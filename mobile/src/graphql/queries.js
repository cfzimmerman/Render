...
`;
export const getUserExtras = /* GraphQL */ `
  query GetUserExtras($id: ID!) {
    getUserExtras(id: $id) {
      id
      cognitosub
      firstvaultupload
...
`;
export const listUserExtras = /* GraphQL */ `
  query ListUserExtras(
    $filter: ModelUserExtrasFilterInput
    $limit: Int
    $nextToken: String
  ) {
    listUserExtras(filter: $filter, limit: $limit, nextToken: $nextToken) {
      items {
        id
        cognitosub
        firstvaultupload
...
`;
export const getUserOTP = /* GraphQL */ `
  query GetUserOTP($id: ID!) {
    getUserOTP(id: $id) {
      id
      currentotp
      userdisplayname
...
`;
export const listUserOTPS = /* GraphQL */ `
  query ListUserOTPS(
    $filter: ModelUserOTPFilterInput
    $limit: Int
    $nextToken: String
  ) {
    listUserOTPS(filter: $filter, limit: $limit, nextToken: $nextToken) {
      items {
        id
        currentotp
        userdisplayname
